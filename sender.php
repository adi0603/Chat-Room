...
$(document).ready(function(e) {
  var ref = setInterval("isOnline();", 2000); 
})
...
<section class="msger">
  ...
  <form class="msger-inputarea">
    <input type="text" class="msger-input" id="message" name="message" title="For Emoji use Window Key + Dot" placeholder="Enter your message...">
...
function isOnline() {
    ...
    if (navigator.onLine) {
        ...
        swal({
            ...
            text: "You are offline please connect to internet!",
            type: "info",
            confirmButtonColor: '#DD6B55',
